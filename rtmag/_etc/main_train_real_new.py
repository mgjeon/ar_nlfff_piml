...
from rtmag.train.model import UNO as UNO_vec
...
elif args.model["model_name"] == "UNO_vec":
    model = UNO_vec(
        hidden_channels = args.model["hidden_channels"],
        in_channels = args.model["in_channels"],
        out_channels = args.model["out_channels"],
...
if args.train == "real_new":
    # from rtmag.train.training_real_new import train, get_dataloaders
    pass
elif args.train == "real_new_vec":
    from rtmag.train.training_real_new_vec import train, get_dataloaders
