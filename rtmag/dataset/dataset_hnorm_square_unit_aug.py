...
class ISEEDataset_Hnorm_Square_Unit_Aug(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        divisor = (self.b_norm / np.arange(1, labels.shape[-1] + 1)**2 ).reshape(1, 1, 1, -1).astype(np.float32)
...
class ISEEDataset_NoLabel_Hnorm_Square_Unit_Aug(Dataset):
...
class ISEEDataset_NoLabel_Hnorm_Square_Unit_Single_Aug(Dataset):
...
class ISEEDataset_Multiple_Hnorm_Square_Unit_Aug(Dataset):
